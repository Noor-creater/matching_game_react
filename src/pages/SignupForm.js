    ...
    validateField(fieldName, value) {
      ...
      switch(fieldName) {
        ...
        case 'checkbox1':
            ...
            fieldValidationErrors.checkbox1 = checkBoxValid1 ? '' : "By clicking checkbox you acknowledge that you agree to our Privacy Policy and Terms and Conditions";
            checkBoxError1 = fieldValidationErrors.checkbox1;
        break;
        case 'checkbox2':
            checkBoxValid2 = value;
            fieldValidationErrors.checkbox2 = checkBoxValid2 ? '' : "By clicking checkbox you acknowledge that you agree to our Rules and Regulations";
            checkBoxError2 = fieldValidationErrors.checkbox2;
        break;
        case 'checkbox3':
            checkBoxValid3 = value;
            fieldValidationErrors.checkbox3 = checkBoxValid3 ? '' : "By clicking checkbox you acknowledge that you agree to receive our biweekly deals";
    ...
    return (
        ...
        <main className="grid-x mainBg">
            <section className=" grid-x large-12 medium-12 small-12">
                <form className="formData large-12 medium-12 small-12" id="signup_form" action="#" onSubmit={this.onSubmitHandler}>
                ...
                <section className="grid-x formContent">
                ...
                <label className="small-10 medium-10 large-10" htmlFor="checkbox1"><p class="checkP">I agree to the <Link to="/privacy-policy"><span class="checkTxt">Privacy Policy</span></Link> and BuyMore Dollars <Link to="/terms-conditions"><span class="checkTxt">Terms and
                    Conditions</span></Link><span>*</span></p></label>
                ...
                <label className="small-10 medium-10 large-10" htmlFor="checkbox2"><p class="checkP">I read, understand, and agree on Official <Link to="/rules-game"><span class="checkTxt">Rules & Regulations</span></Link><span>*</span></p></label>
